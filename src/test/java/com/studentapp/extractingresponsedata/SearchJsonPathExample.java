...
public class SearchJsonPathExample {
    ...
    @Test
    public void test010() {
        List<String> manufactureList=response.extract().path("data.findAll{it.name==~/Ene.*/}.manufacturer");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The manufacturer of products whose name Start = McV are: " +manufactureList);
        System.out.println("------------------End of Test---------------------------");
    }
